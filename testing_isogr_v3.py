...
networks = net.c3d_biclstm(x, num_classes, False, False)
...
load_params = tl.files.load_npz(name='./trained_models/v3/avgfusion/isogr_rgb_birnn_model.npz')
...
load_params = tl.files.load_npz(name='./trained_models/v3/avgfusion/isogr_depth_birnn_model.npz')
tl.files.assign_params(sess, load_params, networks)
average_accuracy = 0.0
test_iterations = 0
...
load_params = tl.files.load_npz(name='./trained_models/v3/avgfusion/isogr_flow_birnn_model.npz')
tl.files.assign_params(sess, load_params, networks)
average_accuracy = 0.0
test_iterations = 0
