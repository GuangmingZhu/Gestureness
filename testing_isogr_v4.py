...
load_params = tl.files.load_npz(name='./trained_models/v4/isogr_rgb_birnn_model.npz')
...
load_params = tl.files.load_npz(name='./trained_models/v4/isogr_depth_birnn_model.npz')
tl.files.assign_params(sess, load_params, networks)
average_accuracy = 0.0
test_iterations = 0
...
load_params = tl.files.load_npz(name='./trained_models/v4/isogr_flow_birnn_model.npz')
tl.files.assign_params(sess, load_params, networks)
average_accuracy = 0.0
test_iterations = 0
